...
ActiveRecord::Schema[7.0].define(version: 2023_02_03_155916) do
  ...
  create_table "organizations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["registration_id"], name: "index_organizations_on_registration_id"
  end
  ...
  create_table "programs", force: :cascade do |t|
    ...
    t.index ["registration_id"], name: "index_programs_on_registration_id"
